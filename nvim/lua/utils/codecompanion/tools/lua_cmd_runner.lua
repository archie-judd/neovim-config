	...
	system_prompt = function(schema)
		return string.format(
			...
			- Each command  should:
				...
				- Follow the XML schema exactly. Do not include multiple commands in a single action. 
			- If you are asked to run multiple lua commands, combine them into a single command. 
			- If the user has specified to force the command, set force to true, otherwise set it to false. 
			Setting force to true will bypass the user approval mechanism.
